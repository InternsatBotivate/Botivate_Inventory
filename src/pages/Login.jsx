...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (success) {
      ...
      const mainPages = [
        "Dashboard Overview","Raw Material Data","Finished Good Data"
      ];
      ...
      if (pagesss === "Dashboard Overview") {
        navigate("/combined-dashboard");
      } else if (pagesss === "Raw Material Data") {
        navigate("/raw-materials-table");
      } else if (pagesss === "Finished Good Data") {
